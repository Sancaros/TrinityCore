...
{
   // sLog->outDebug("LOG_FILTER_CHALLENGE", "GenerateOploteLoot manual %u _challengeWeekList %u", manual, _challengeWeekList.size());
...
bool ChallengeMgr::IsChest(uint32 goEntry)
{
    switch (goEntry)
    {
        ...
        case 282736: // Toldagor
        case 282737: // Atal Dazar
        case 290544: // The MotherLode
        case 290621: // Waycrest Manor
        case 288642: // KING rest
        case 290758: // Temple of sertralis
        case 290759: // The underroot
        case 290761: // Shrine of storm
        case 288644: // Siege of boralus
        case 338193: // Op mechagon 1
        case 338194: // Op mechagon 2
        case 354985: // De other Side
        case 354972: // MIST of tirna
        case 354991: // Theater of Pain
        case 354989: // Spires of ascencion
        case 354987: // Plaguefall
        case 354990: // The Necrotic Wake
        case 354988: // Sanguine Depths
        case 354986: // Halls of Atonement
            return true;
        default:
            break;
    }
