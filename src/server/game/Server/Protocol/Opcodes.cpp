...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_CHECK_IS_ADVENTURE_MAP_POI_VALID,                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCheckIsAdventureMapPoiValide);
    ...
    DEFINE_HANDLER(CMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY,                   STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleConsumableTokenCanVeteranBuy);
    ...
    DEFINE_HANDLER(CMSG_CREATE_SHIPMENT,                                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGarrisonCreateShipmentOpcode);
    ...
    DEFINE_HANDLER(CMSG_AUTO_GUILD_BANK_ITEM,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDepositGuildBankItem);
    ...
    DEFINE_HANDLER(CMSG_DISCARDED_TIME_SYNC_ACKS,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDiscardedTimeSyncAcks);
    ...
    DEFINE_HANDLER(CMSG_ISLAND_QUEUE,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleIslandQueue);
    ...
    DEFINE_HANDLER(CMSG_LEAVE_PET_BATTLE_QUEUE,                             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBattlePetLeaveQueue);
    ...
    DEFINE_HANDLER(CMSG_QUERY_BATTLE_PET_NAME,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBattlePetNameQuery);
    ...
    DEFINE_HANDLER(CMSG_WARDEN3_DATA,                                       STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleWardenData);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ALLIED_RACE_DETAILS,                     STATUS_NEVER,        CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLE_PET_SET_MAX_PETS,                 STATUS_NEVER,        CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY_RESPONSE, STATUS_NEVER,      CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_DISPLAY_TOAST,                           STATUS_NEVER,        CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GARRISON_UPDATE_FOLLOWER,                STATUS_NEVER,        CONNECTION_TYPE_INSTANCE);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GET_TROPHY_LIST_RESPONSE,                STATUS_NEVER,        CONNECTION_TYPE_INSTANCE);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED,  STATUS_NEVER,        CONNECTION_TYPE_INSTANCE); //need add
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INSTANCE_ENCOUNTER_START,                STATUS_NEVER,        CONNECTION_TYPE_INSTANCE);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INSTANCE_ENCOUNTER_TIMER_START,          STATUS_NEVER,        CONNECTION_TYPE_INSTANCE); // need add
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MYTHIC_PLUS_WEEKLY_REWARD_RESPONSE,      STATUS_NEVER,        CONNECTION_TYPE_REALM);//
