...
enum OpcodeClient : uint16
{
    ...
    CMSG_MYTHIC_PLUS_WEEKLY_REWARD_REQUEST            = 0x3091,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_BATTLE_PAY_VAS_GUILD_FOLLOW_INFO             = 0x2772,
    SMSG_BATTLE_PAY_VAS_GUILD_MASTER_LIST             = 0x276C,
    ...
    SMSG_BATTLE_PET_SET_MAX_PETS                      = 0x2593,
    ...
    SMSG_MYTHIC_PLUS_NEW_SEASON_RECORD                = 0x2606,
    SMSG_MYTHIC_PLUS_NEW_WEEK_RECORD                  = 0x2607,
    SMSG_MYTHIC_PLUS_SEASON_DATA                      = 0x2603,
    SMSG_MYTHIC_PLUS_WEEKLY_REWARD_RESPONSE           = 0x2609,
    ...
    SMSG_QUEST_UPDATE_COMPLETE_BY_SPELL               = 0x2A82,
