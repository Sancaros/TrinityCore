...
void BattlePet::Save(CharacterDatabaseTransaction& trans)
{
    ...
    statement->setUInt32(3, Species);
    statement->setUInt32(4, Quality);
    statement->setUInt32(5, Breed);
    statement->setUInt32(6, Level);
    statement->setUInt32(7, XP);
    statement->setUInt32(8, DisplayModelID);
    statement->setInt32(9, Health);
    statement->setUInt32(10, Flags);
    statement->setInt32(11, InfoPower);
    statement->setInt32(12, InfoMaxHealth);
    statement->setInt32(13, InfoSpeed);
    statement->setInt32(14, InfoGender);
    statement->setString(15, DeclinedNames[0]);
    statement->setString(16, DeclinedNames[1]);
    statement->setString(17, DeclinedNames[2]);
    statement->setString(18, DeclinedNames[3]);
    statement->setString(19, DeclinedNames[4]);
    statement->setInt32(20, AccountID);
...
void BattlePet::AddToPlayer(Player* player, CharacterDatabaseTransaction& trans)
{
    ...
    player->UpdateCriteria(CriteriaType::UniquePetsOwned, 1);
...
ObjectGuid::LowType BattlePet::AddToPlayer(Player* player)
{
    ...
    statement->setInt32(13, InfoSpeed);
    statement->setInt32(14, InfoGender);
    statement->setInt32(15, AccountID);
    statement->setString(16, DeclinedNames[0]);
    statement->setString(17, DeclinedNames[1]);
